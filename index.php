      ...
      <div class="container_full slider-bg">
        <div class="fix container">
          <div class="slider-top">
            <h1>Welcome to Home Rental Service</h1>
...
<button style="margin-left:90px; margin-bottom:10px;"   onclick="myFunction()">View Details</button>
...
<?php }}?>
    ...
    <section class="section-padding orange-bg">
      <div class="container">
        ...
        <div style="width:1160px;margin-bottom:20px;" class="row map">
...
while($data=mysqli_fetch_array($result))
{
  ...
  ?>
          ...
          <div class="col-md-3 col-sm-6 calwid">
            ...
            <div style="width:465px;margin-left:46px;" class="calendar"><iframe src="https://calendar.google.com/calendar/embed?src=asifhayatanjon%40gmail.com&ctz=Asia%2FDhaka" style="border: 5px solid gray" width="465" height="400" frameborder="0" scrolling="yes"></iframe></div>
