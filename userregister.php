...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["userconfirm_password"]))){
        $confirm_password_err = "Please confirm password.";
    } else{
        $confirm_password = trim($_POST["userconfirm_password"]);
    ...
    if(empty($firstname_err) && empty($lastname_err) && empty($username_err) && empty($address_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO user (userfirstname,userlastname,username,useraddress,useremail, userpassword) VALUES (?, ?, ?, ?, ?, ?)";
      ...
      <div class="container">
        ...
        <div class="wrapper">
       		...
       		<div class="form-group <?php echo (!empty($firstname_err)) ? 'has-error' : ''; ?>">
                       ...
                       <input type="text" name="userfirstname" class="form-control" value="<?php echo $firstname; ?>">
                       <span class="help-block"><?php echo $firstname_err; ?></span>
                   </div>
       			<div class="form-group <?php echo (!empty($lastname_err)) ? 'has-error' : ''; ?>">
                       <label>LastName</label>
                       <input type="text" name="userlastname" class="form-control" value="<?php echo $lastname; ?>">
                   ...
                   <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                       ...
                       <label>Address</label>
                       <input type="text"  name="useraddress" class="form-control" value="<?php echo $address; ?>">
       ...
       <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
                   ...
                   <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                       ...
                       <input type="password" name="userpassword" class="form-control" value="<?php echo $password; ?>">
                       <span class="help-block"><?php echo $password_err; ?></span>
                   </div>
                   <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                       <label>Confirm Password</label>
                       <input type="password" name="userconfirm_password" class="form-control" value="<?php echo $confirm_password; ?>">
