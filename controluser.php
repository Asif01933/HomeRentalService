...
$eid=intval($_GET['eid']);
$status=1;
$sql = "UPDATE user SET status=:status WHERE  userid=:eid";
$query = $dbh->prepare($sql);
        ...
        <div style="background:grey;" class="topnav1" id="myTopnav">
                        ...
                        <input id="myInput" type="text" placeholder="Search..">
          						...
          						<div >
          						  ...
          						  <?php if($msg){?><div style='font-weight:bold;color:green;font-weight:bold;text-align:center;'><?php echo htmlentities($msg); ?> </div><?php }?>
          								<table   class="display table table-striped table-bordered table-hover" border="1" cellspacing="0" width="100%">
          									<thead>
          										<tr>
          										<th>Serial</th>
          											<th>First Name</th>
                                ...
                                <th>Approval</th>
                                	<th>Delete</th>
          									...
          									<?php $sql = "SELECT * from  user order by userid desc";
          $query = $dbh -> prepare($sql);
          $query->execute();
          ...
          {				?>
          										<tr>
          											...
          											<td><?php echo htmlentities($result->userfirstname);?></td>
          											<td><?php echo htmlentities($result->userlastname);?></td>
...
<td><a style="color:red" href="controluser.php?eid=<?php echo $result->userid;?>" onclick="return confirm('Do you want to approve');" >Approve</a>
</td>
<?php } ?>
                                <td><a href="controluser.php?del=<?php echo $result->userid;?>" onclick="return confirm('Do you want to delete');" >Delete</a></td>
                              </tr>
          										<?php $cnt=$cnt+1; }} ?>
